...
public class ResourceController{
    ...
    @GetMapping("/menu")
    public ResponseBean getAuthorityMenu(HttpServletRequest request) {
       // String uid = request.getHeader("appId");
        List<MenuTreeNode> treeNodes = new ArrayList<>();
        List<AuthResource> resources = resourceService.selectAuthorityMenus();
        ...
        return new ResponseBean(200,"return menu list success",menuTreeNodes);
    }
