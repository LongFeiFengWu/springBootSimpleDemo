...
import demo.dao.AuthResourceMapper;
...
public class ResourceServiceImpl implements ResourceService {
    ...
    @Override
    public List<AuthResource> selectAuthorityMenus() throws DataAccessException {
    	return authResourceMapper.selectAuthorityMenus();
    }
